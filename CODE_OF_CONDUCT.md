...
This Code of Conduct applies within all community spaces of this project, including
its issue tracker and pull requests, and also applies when an individual is officially
representing the community in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported by
opening an issue in this repository's issue tracker and mentioning **@Ab-Romia**
directly, or, where the report itself needs to stay private, through GitHub's private
vulnerability reporting on this repository, which reaches the same person without the
report being public first. All complaints will be reviewed and investigated promptly
and fairly.
